import pluginNoJQuery from 'eslint-plugin-no-jquery';

export default [
	{
		name: 'wikimedia/jquery',
		plugins: {
			'no-jquery': pluginNoJQuery
		},
		languageOptions: {
			globals: {
				$: 'readonly'
		...
		rules: {
			...pluginNoJQuery.configs.recommended.rules,
			...pluginNoJQuery.configs['deprecated-3.7'].rules,
